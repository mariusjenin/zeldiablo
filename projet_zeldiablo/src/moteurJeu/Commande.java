...
public class Commande {
	...
	/**
	 * constructeur par copie copie la commande pour en creer une nouvelle
	 * 
	...
	public Commande(Commande commandeACopier) {
		...
		this.tp = commandeACopier.tp;
		this.repousse = commandeACopier.repousse;
	}
